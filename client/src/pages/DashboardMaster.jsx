...
const DashboardMaster = () => {
  const getMasterId = () => {
    ...
    return localStorage.getItem('@Cidademdia:userId') || 'Master';
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm font-medium text-blue-50 bg-white/10 px-3 py-1.5 rounded-lg border border-white/10">
              Gerente ID: <span className="font-mono text-yellow-300">{masterId && masterId !== 'Master' ? masterId.slice(-6) : 'Master'}</span>
            </span>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className="lg:col-span-2 space-y-6">
          <div className="bg-gradient-to-r from-slate-900 to-blue-900 text-white p-6 rounded-2xl shadow-sm border border-slate-800">
            <h2 className="text-xl font-bold tracking-tight">Painel Operacional Master 👋</h2>
            <p className="text-xs text-slate-300 font-light mt-1">Alternar modos operacionais abaixo para visualizar dados brutos da prefeitura ou gerenciar chaves de acesso subordinadas.</p>
          </div>
